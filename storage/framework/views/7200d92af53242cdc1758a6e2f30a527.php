...
<!-- Stats Cards - TANPA IKON -->
<div class="row g-3 mb-4">
    <div class="col-xl-2 col-md-4 col-sm-6">
        <div class="stat-card-admin h-100 text-center">
            <h3 class="stat-number mb-2"><?php echo e(number_format($stats['total'])); ?></h3>
    ...
    <div class="col-xl-2 col-md-4 col-sm-6">
        <div class="stat-card-admin h-100 text-center">
            <h3 class="stat-number mb-2"><?php echo e(number_format($stats['pending'])); ?></h3>
    ...
    <div class="col-xl-2 col-md-4 col-sm-6">
        <div class="stat-card-admin h-100 text-center">
            <h3 class="stat-number mb-2"><?php echo e(number_format($stats['processing'])); ?></h3>
    ...
    <div class="col-xl-2 col-md-4 col-sm-6">
        <div class="stat-card-admin h-100 text-center">
            <h3 class="stat-number mb-2"><?php echo e(number_format($stats['completed'])); ?></h3>
    ...
    <div class="col-xl-2 col-md-4 col-sm-6">
        <div class="stat-card-admin h-100 text-center">
            <h3 class="stat-number mb-2"><?php echo e(number_format($stats['cancelled'])); ?></h3>
    ...
    <div class="col-xl-2 col-md-4 col-sm-6">
        <div class="stat-card-admin h-100 text-center">
            <h3 class="stat-number mb-2 text-truncate">Rp <?php echo e(number_format($stats['revenue'], 0, ',', '.')); ?></h3>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <span class="badge bg-secondary"><?php echo e($order->items->count() ?? 0); ?></span>
                        </td>
        ...
        <div class="d-flex justify-content-between align-items-center mt-4">
            <div>
                <p class="mb-0 text-muted">
                    Menampilkan <?php echo e($orders->firstItem() ?? 0); ?> - <?php echo e($orders->lastItem() ?? 0); ?> dari <?php echo e($orders->total()); ?> pesanan
                </p>
            </div>
            <div>
...
<style>
    /* Stat Cards - SEDERHANA TANPA IKON */
    .stat-card-admin {
        background: white;
        border-radius: 12px;
        padding: 1.5rem 1rem;
    ...
    /* Border colors for each stat card */
    ...
    /* Subtle background colors on hover */
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\KULIAH\SERTIFIKASI\stationery_shop\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>