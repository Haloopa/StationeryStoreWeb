                    ...
                    <?php if($orders->isEmpty()): ?>
                        <div class="text-center py-5 px-4">
                            <div class="empty-state">
                                ...
                                <a href="<?php echo e(route('products.index')); ?>" class="btn btn-primary px-4">
                        ...
                        <div class="row g-3 px-4 pt-4">
                            <div class="col-md-3">
                                <div class="stat-box p-3 rounded text-center">
                                    <div class="stat-number text-primary fw-bold fs-4"><?php echo e($orders->total()); ?></div>
                            ...
                            <div class="col-md-3">
                                <div class="stat-box p-3 rounded text-center">
                                    <div class="stat-number text-warning fw-bold fs-4">
                                        <?php echo e($orders->whereIn('status', ['pending', 'processing'])->count()); ?>
                                ...
                                <div class="order-card mb-3 border rounded">
                                    <div class="order-header p-3 bg-light">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="mb-1 fw-bold text-primary"><?php echo e($order->order_number); ?></h6>
                                            ...
                                            <div class="text-end">
                                                <span class="badge bg-<?php echo e($order->status_badge); ?> fs-6 px-3 py-2">
                                                    <?php echo e($order->status_text); ?>

                                                </span>
                                                <div class="mt-2">
                                                    <small class="text-muted"><?php echo e($order->items_count); ?> item</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <span class="fw-semibold">Rp <?php echo e(number_format($item->subtotal, 0, ',', '.')); ?></span>
                                                    </div>
                                                    <small class="text-muted">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <p class="text-muted small mb-0">
                                    Menampilkan <?php echo e($orders->firstItem() ?? 0); ?> - <?php echo e($orders->lastItem() ?? 0); ?> 
                                    dari <?php echo e($orders->total()); ?> pesanan
                                </p>
                            </div>
                            <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\KULIAH\SERTIFIKASI\stationery_shop\resources\views/orders/index.blade.php ENDPATH**/ ?>