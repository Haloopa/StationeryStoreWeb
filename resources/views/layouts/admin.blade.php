...
@if(!Auth::user()->isAdmin())
    <div class="alert alert-danger">
        ...
        <a href="{{ route('store') }}" class="alert-link">Kembali ke toko</a>
    </div>
    @php exit(); @endphp
@endif
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.users.index') }}">Pengguna/Admin</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{ route('store') }}" target="_blank">
    ...
    <div class="admin-header">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="mb-2">@yield('title', 'Dashboard Admin')</h1>
