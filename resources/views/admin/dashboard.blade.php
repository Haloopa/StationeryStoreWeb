        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card-admin">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="stat-number mb-0">{{ App\Models\Product::count() }}</h3>
                        <p class="stat-label mb-0">Total Produk</p>
                    </div>
                </div>
                <div class="stat-info mt-2">
                    <span class="badge bg-success">{{ App\Models\Product::where('is_active', true)->count() }} aktif</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card-admin">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="stat-number mb-0">{{ App\Models\Category::count() }}</h3>
                        <p class="stat-label mb-0">Total Kategori</p>
                    </div>
                </div>
                <div class="stat-info mt-2">
                    <span class="badge bg-info">{{ App\Models\Category::has('products')->count() }} terpakai</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card-admin">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="stat-number mb-0">{{ App\Models\User::count() }}</h3>
                        <p class="stat-label mb-0">Total User</p>
                    </div>
                </div>
                <div class="stat-info mt-2">
                    <span class="badge bg-primary">{{ App\Models\User::where('role', 'user')->count() }} customer</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card-admin">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="stat-number mb-0">{{ App\Models\Order::count() }}</h3>
                        <p class="stat-label mb-0">Total Pesanan</p>
                    </div>
                </div>
                <div class="stat-info mt-2">
                    <span class="badge bg-warning">{{ App\Models\Order::where('status', 'pending')->count() }} pending</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="admin-card rounded-3">
                <div class="card-header d-flex justify-content-between align-items-center py-3 rounded-top-3">
                    ...
                    <a href="{{ route('admin.products.index') }}" class="btn btn-sm btn-admin-outline rounded-pill">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover admin-table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="ps-4 fw-semibold">{{ Str::limit($product->name, 25) }}</td>
                                    <td>
                                        @if($product->category)
                                    ...
                                    <td class="text-primary fw-semibold">Rp {{ number_format($product->price, 0, ',', '.') }}</td>
                                    <td>
            ...
            <div class="admin-card rounded-3 mt-4">
                <div class="card-header d-flex justify-content-between align-items-center py-3 rounded-top-3">
                    ...
                    <a href="{{ route('admin.orders.index') }}" class="btn btn-sm btn-admin-outline rounded-pill">
                        Lihat Semua <i class="bi bi-arrow-right ms-1"></i>
                    </a>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover admin-table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="ps-4 fw-semibold">#{{ $order->invoice }}</td>
                                    <td>
                                        @if($order->user)
                                            {{ Str::limit($order->user->name, 20) }}
                                        @else
